...
function seletorPagina() {
  ...
  if (paginaAtual === 0) {
    ...
    enunciadoPrincipal.innerHTML = `Ola! Vamos calcular sua pegada ecológica? `; // Mensagem de boas-vindas
    ...
    enunciadoPrincipal.innerHTML = `<p class="descricao-resultado">Aqui esta sua pegada ecológica, ${nome}!</p>`;
    ...
    )}s para responder esse questionario.</p>`;
